...
![register](img/images3/register.png)
...
![on1](img/images3/on1.png)

![on2](img/images3/on2.png)

![on3](img/images3/on3.png)
...
![t1](img/images3/t1.png)

![t2](img/images3/t2.png)
...
![noconfig](img/images3/noconfig.png)
...
![water](img/images3/water.png)

![](img/images3/download.png)
...
```javascript
	...
	<section id="gallery-wrapper">
        <article class="white-panel">
            <img src="img/images3/P_000.jpg" class="thumb">
            <h1><a href="#">我是轮播图片1</a></h1>
            <p>里面很精彩哦</p>
        </article>
        <article class="white-panel">
            <img src="img/images3/P_005.jpg" class="thumb">
            <h1><a href="#">我是轮播图片1</a></h1>
            <p>里面很精彩哦</p>
        </article>
        <article class="white-panel">
            <img src="img/images3/P_006.jpg" class="thumb">
            <h1><a href="#">我是轮播图片1</a></h1>
            <p>里面很精彩哦</p>
        </article>
        <article class="white-panel">
            <img src="img/images3/P_007.jpg" class="thumb">
            <h1><a href="#">我是轮播图片1</a></h1>
            <p>里面很精彩哦</p>
        </article>
    </section>

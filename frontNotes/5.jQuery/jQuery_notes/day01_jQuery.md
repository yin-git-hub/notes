...
- jQuery 出现的目的是加快前端人员的开发速度，我们可以非常方便的调用和使用它，从而提高开发效率。
  ...
  ![jQuery概述](img/images1/jQuery概述.jpg)
...
![jQuery对象和DOM对象](img/images1/jQuery对象和DOM对象.png)
...
​	![基础选择器](img/images1/基础选择器.png)

### 1.3.2. 层级选择器

​	层级选择器最常用的两个分别为：后代选择器和子代选择器。

​	![层级选择器](img/images1/层级选择器.png)
...
![show](img/images1/show.png)

![hide](img/images1/hide.png)

![toggle](img/images1/toggle.png)
...
![slideDown](img/images1/slideDown.png)

![slideUp](img/images1/slideUp.png)

![slideToggle](img/images1/slideToggle.png)
...
![fadeIn](img/images1/fadeIn.png)

![fadeOut](img/images1/fadeOut.png)

![fadeToggle](img/images1/fadeToggle.png)

![fadeTo](img/images1/fadeTo.png)

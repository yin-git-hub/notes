...
如上两行代码运行结果为:![](img/images1/img3.png)
...
- 子类使用super关键字访问父类的方法
  ...
  **注意:** 
  ...
  5. 在 ES6 中类没有变量提升，所以必须先定义类，才能通过类实例化对象![](img/images1/img2.png)

     ## ![](img/images1/img1.png)

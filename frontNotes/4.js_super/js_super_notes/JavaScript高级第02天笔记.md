...
静态 在构造函数本身上添加的成员  如下列代码中 sex 就是静态成员,静态成员只能通过构造函数来访问
...
![](img/images2/img8.png)如果未设置constructor属性,如图:

![](img/images2/img9.png)

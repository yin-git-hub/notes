...
def main():
    # 请自行修改下面的邮件发送者和接收者
    sender = 'yin82347331@163.com'
    receivers = ['191379744@qq.com']
    message = MIMEText('用Python发送邮件的示例代码.', 'plain', 'utf-8')
    message['From'] = 'Give<yin82347331@163.com>'
    message['To'] = 'Give<191379744@qq.com>'
    message['Subject'] = Header('示例代码实验邮件', 'utf-8')
    smtper = SMTP('smtp.163.com')
    # 请自行修改下面的登录口令
    smtper.login(sender, 'LXIFWNBTHODTTGJS')
